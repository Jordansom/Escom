...
plt.title("Grafica - Fuerza",color='red',size=16, family="Tahoma")
...
raiz.title("  \t\t\t\t Sensor pizoelectrico")
raiz.geometry("800x402")
raiz.resizable(1,1)
...
labelx = StringVar(raiz, "Fuerza: 0.00")
